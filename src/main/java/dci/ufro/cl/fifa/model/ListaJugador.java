...
public class ListaJugador {
    ...
    public static void agregarJugadores(){
        String jugadoresTotal= ManejoArchivo.leerArchivo("data.csv");
        ...
        for(int i=1;i<jugadoresSep.length;i++){
            ...
            if(datosPlayer.length>20) {
                int id = Integer.parseInt(datosPlayer[1].trim());
                ...
                listaJugadores.add(new Jugador(id, fotografia, nombre, nacionalidad, rating, edad, club, potencial, velocidad, controlBalon, agilidad, resistencia));
            } else {
                int id = Integer.parseInt(datosPlayer[1].trim());
                String fotografia = datosPlayer[4];
                String nombre = datosPlayer[2];
                ...
                String club = datosPlayer[9];
                int potencial = Integer.parseInt(datosPlayer[8].trim());
                listaJugadores.add(new Jugador(id,fotografia, nombre, nacionalidad, rating, edad, club, potencial, -1, -1, -1, -1));
            }
        }
    }
